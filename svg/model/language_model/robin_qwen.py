...
from ..robin_arch import RobinMetaModel, RobinMetaForCausalLM

from ..layer import MaskExtractor

class RobinQwenConfig(Qwen2Config):
    model_type = "robin_qwen"


class RobinQwenModel(RobinMetaModel, Qwen2Model):
    config_class = RobinQwenConfig

    def __init__(self, config: Qwen2Config):
        super(RobinQwenModel, self).__init__(config)


class RobinQwenForCausalLM(Qwen2ForCausalLM, RobinMetaForCausalLM):
    config_class = RobinQwenConfig
    ...
    def __init__(self, config):
        ...
        self.model = RobinQwenModel(config)
...
AutoConfig.register("robin_qwen", RobinQwenConfig)
AutoModelForCausalLM.register(RobinQwenConfig, RobinQwenForCausalLM)
